# Fitness Tracker Project Memory

## Feedback (rules + validated approaches)
- [Brace before move, not during](feedback_brace_before_move.md) - 360-degree IAP brace must precede every transition / loaded action; this is the foundational disc-protection technique
- [Double progression with baseline cap](feedback_double_progression_with_baseline_cap.md) - 10-15 rep range, hit 15 clean across all sets, bump 2.5kg back to 10, capped at pre-injury baseline until doctor clears
...
- [Thermal treatment at Caldas de Sao Jorge](project_thermal_treatment_caldas_sao_jorge.md) - 2 sessions/week Tue+Fri 18:00; pool physio swapped treadmill walking for recumbent bike
